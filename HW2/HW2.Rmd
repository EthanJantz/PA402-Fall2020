...
`r describe(selected) %>% paged_table()`
...
With such a low Alpha Reliability Coefficient these variables don't have a shared covariance, meaning they don't seem to measure the same "concept." 
